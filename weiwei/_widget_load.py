...
class LoadAtlas(QWidget):
    ...
    def __init__(self, napari_viewer, *, show=False):
        ...
        array_id_label = widgets.Label(value="array_id")
        self.array_id = widgets.LineEdit(value="orig.ident")
        array_id = widgets.Container(
            widgets=[array_id_label, self.array_id], labels=False
        )
        ...
        params = widgets.Container(
            widgets=[tissue_id, pos_reg_id, gene_name_id, umap_id,z_resolusion,z_space,array_id],
            labels=False,
        )
